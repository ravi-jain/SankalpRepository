 ...
 */
public class SpCaldroidCalendarViewHandler {
    ...
    public SpCaldroidCalendarViewHandler(Context applicationContext, String context, FragmentManager manager, int contentFrameId)
    {
        _context = context;
